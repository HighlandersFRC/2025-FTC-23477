    ...
    public void runOpMode() throws InterruptedException {
        ...
        scheduler.schedule(
                new SequentialCommandGroup(scheduler,
                        ...
                        new Wait(0),
                        new CommandDrive(robot.driveStates, 0.5),// forward 1 meter, Mouse.X reset internally
                        new Wait(0),
                        new CommandIntake(robot.intakeStates, 1000),
                        new Wait(0),
                        new CommandTurnRight(robot.driveStates, 180),
                        new Wait(0),
                        new CommandDrive(robot.driveStates, 0.5),
                        new Wait(0),
                        new CommandTurnLeft(robot.driveStates, -35),
                        new SequentialCommandGroup(scheduler,
                                new ConditionalCommand(
                                        new ParallelCommandGroup(
                                                scheduler, Parameters.ALL,
